public class CalcCounterMain {
    ...
    public static void main(String[] args) {
      ...
      //  double resultMath2= counter2.add(counter.add(4.1,counter2.multipl(15,7)),counter2.power(counter2.divis(28,5),2));

        //System.out.println(resultMath);
        //System.out.println(resultMath2);

        System.out.println("Количество произведенны операций="+counter.getCountOperation());
